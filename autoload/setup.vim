...
" ./pack/original/start/tagbar/
"-----------------------------------------------------------------------------"
function! setup#tagbar(file_uctags)
    let g:tagbar_ctags_bin = a:file_uctags
    let g:tagbar_sort = 0
...
function! setup#grep()
    ...
    nnoremap <C-h> :<C-U><C-R>=printf("grep! -HIsnri " . util#SetInclude() . "--exclude=\\*.{" . g:grep_exclude . "} --exclude=tags --exclude=\\*.tags %s", expand("<cword>"))<CR>
    xnoremap <C-h> :<C-U><C-R>=printf("grep! -HIsnri " . util#SetInclude() . "--exclude=\\*.{" . g:grep_exclude . "} --exclude=tags --exclude=\\*.tags %s", util#GrepEscape(@*))<CR>
